...
## Установка драйвера
**📦 Драйвер входит в состав установщика и устанавливается автоматически.
Если драйвер не установился — зайдите в архив AirPodsControl.zip из Releases, найдите папку Driver внутри архива и установите вручную через Диспетчер устройств.**
